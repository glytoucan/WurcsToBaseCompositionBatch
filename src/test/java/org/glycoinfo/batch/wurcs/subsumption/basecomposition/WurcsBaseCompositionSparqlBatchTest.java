package org.glycoinfo.batch.wurcs.subsumption.basecomposition;
...
import org.glycoinfo.batch.wurcs.subsumption.basecomposition.app.Config;
import org.glycoinfo.batch.wurcs.subsumption.basecomposition.app.ProcessorConfig;
...
@SpringApplicationConfiguration(classes = { WurcsBaseCompositionSparqlBatchTest.class, Config.class, VirtSesameTransactionConfig.class, GlyConvertConfig.class, ProcessorConfig.class})
//@SpringApplicationConfiguration(classes = { WurcsTopologySparqlBatch.class })
@IntegrationTest
@EnableAutoConfiguration
public class WurcsBaseCompositionSparqlBatchTest {
...
//    String output = glycanProcedure.register("WURCS=2.0/7,9,8/[a2122h-1b_1-5_2*NCC/3=O][a1122h-1b_1-5][a1122h-1a_1-5][a221h-1x_1-5][a2112h-1x_1-5][a1221m-1x_1-5][a1221m-1a_1-5]/1-1-2-3-4-5-3-6-7/a4-b1_a6-i1_b4-c1_c3-d1_c6-g1_d?-e1_e?-f1_g?-h1", "254");
    ...
    String id1 = processed.getValue(BaseCompositionInsertSparql.PrimaryId_1);
    String id2 = processed.getValue(BaseCompositionInsertSparql.PrimaryId_2);
