...
public class CompositionConverter implements SparqlEntityConverter<SparqlEntity> {
  ...
  public SparqlEntity convert(SparqlEntity e) throws SparqlException {
    ...
    e.setValue(BaseCompositionInsertSparql.PrimaryId_1, e.getValue(Saccharide.PrimaryId));

    // topology acc num => PrimaryId_2
    e.setValue(BaseCompositionInsertSparql.PrimaryId_2, topAccessionNumber);
